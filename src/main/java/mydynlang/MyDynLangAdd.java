...
public class MyDynLangAdd {
    ...
    public static CallSite bootstrap(MethodHandles.Lookup lookup,
                                     String name, MethodType type) throws Exception {
        ...
        MethodHandle dispatcher = lookup.findStatic(
            MyDynLangAdd.class,
            "dispatcher",
            MethodType.methodType(/*Return type=*/String.class,
                MutableCallSite.class, MethodHandles.Lookup.class, String.class, String.class));
    ...
    public static String dispatcher(MutableCallSite callsite,
                                      MethodHandles.Lookup lookup,
                                      String left,
                                      String right) throws Throwable {
                                          
        // if (!(left instanceof String) && !(right instanceof String)) {
        //     throw new RuntimeException("Expected both arguments to be strings!");
        // }
        
        // // Perform Type Check
        // String leftAsString = (String) left;
        // String rightAsString = (String) right;
        ...
        if (leftIsInt && rightIsInt) {
            newmh = lookup.findStatic(
                MyDynLangAdd.class, "addInts",
                MethodType.methodType(String.class, String.class, String.class)
            );
        } else if (leftIsInt && !rightIsInt) {
            throw new RuntimeException("Cannot add String to Integer, LHS has to be String!");
        } else {
            newmh = lookup.findStatic(
                MyDynLangAdd.class, "concatStrings",
                MethodType.methodType(String.class, String.class, String.class)
            );
        }
